...
class UserController {
    ...
    async loginGoogle(req, res, next){
        try{
            ...
            async function verify() {
                ...
                // const idd = mongoose.Types.ObjectId(userid.toString())
        ...
        try {
            ...
            if (req.file){
                if(req.file.fieldname === 'avatar')
                    await User.findByIdAndUpdate(id, {avatar: req.file.path})
                else
                    await User.findByIdAndUpdate(id, {resumeCV: req.file.path})
    ...
    async getFilteredTalents(req, res, next){
    ...
    async updateToken(req, res, next) {
        ...
        try {
            ...
            // const token = generate_jwt_token(req.user.id, req.user.email, req.user.role, req.user.skills, req.user.companies)
